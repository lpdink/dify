...
class BuiltinToolProvider(db.Model):
    ...
    __table_args__ = (
        ...
        db.UniqueConstraint('id', 'tenant_id', 'provider', name='unique_builtin_tool_provider')
    )
...
class PublishedAppTool(db.Model):
    ...
    __table_args__ = (
        ...
        db.UniqueConstraint('id', 'app_id', 'user_id', name='unique_published_app_tool')
    )
...
class ApiToolProvider(db.Model):
    ...
    __table_args__ = (
        ...
        db.UniqueConstraint('id', 'name', 'tenant_id', name='unique_api_tool_provider')
    )
...
class ToolLabelBinding(db.Model):
    ...
    __table_args__ = (
        ...
        db.UniqueConstraint('id', 'tool_id', 'label_name', name='unique_tool_label_bind'),
    )
...
class WorkflowToolProvider(db.Model):
    ...
    __table_args__ = (
        ...
        db.UniqueConstraint('id', 'name', 'tenant_id', name='unique_workflow_tool_provider'),
        db.UniqueConstraint('id', 'tenant_id', 'app_id', name='unique_workflow_tool_provider_app_id'),
    )
