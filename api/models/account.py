...
class TenantAccountJoin(db.Model):
    ...
    __table_args__ = (
        ...
        db.UniqueConstraint('id', 'tenant_id', 'account_id', name='unique_tenant_account_join')
    )
...
class AccountIntegrate(db.Model):
    ...
    __table_args__ = (
        ...
        db.UniqueConstraint('id', 'account_id', 'provider', name='unique_account_provider'),
        db.UniqueConstraint('id', 'provider', 'open_id', name='unique_provider_open_id')
    )
