...
class Provider(db.Model):
    ...
    __table_args__ = (
        ...
        db.UniqueConstraint('id', 'tenant_id', 'provider_name', 'provider_type', 'quota_type', name='unique_provider_name_type_quota')
    )
...
class ProviderModel(db.Model):
    ...
    __table_args__ = (
        ...
        db.UniqueConstraint('id', 'tenant_id', 'provider_name', 'model_name', 'model_type', name='unique_provider_model_name')
    )
